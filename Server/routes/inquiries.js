...
router.get('/mine', protect, requireRole('tailor'), async (req, res) => {
...
router.get('/customer', protect, requireRole('customer'), async (req, res) => {
...
router.patch('/:id/read', protect, requireRole('tailor'), async (req, res) => {
  const tailor = await Tailor.findOne({ owner: req.user._id })
...
router.get('/unread-count', protect, requireRole('tailor'), async (req, res) => {
  const tailor = await Tailor.findOne({ owner: req.user._id })
